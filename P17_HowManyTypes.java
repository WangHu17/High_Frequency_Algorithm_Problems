...
/**
 * @author wanghu
 * @discrption： 只由小写字母（a~z）组成的一批字符串，都放在字符类型的数组 String[] arr 中，如果其中某两个字符串所含有的字符种类完全一样，就将两个字符串算作一类。
 * 比如：baacbba 和 bab 就算作一类，返回arr中有多少类？
 * @create 2022-08-04 15:25
 */
public class P17_HowManyTypes {
